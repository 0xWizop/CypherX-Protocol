        ...
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center space-x-2">
            <div className={`flex items-center space-x-1 px-1.5 py-0.5 rounded-md ${connectionStatus === "Connected" ? "bg-green-500/20" : "bg-red-500/20"}`}>
              <span className={`w-1 h-1 rounded-full ${connectionStatus === "Connected" ? "bg-green-400" : "bg-red-400"}`} />
              <span className={`text-[11px] font-medium ${connectionStatus === "Connected" ? "text-green-400" : "text-red-400"}`}>
                {connectionStatus}
              </span>
            </div>
            <div className="flex items-center space-x-1">
              <span className="text-[11px] text-gray-500">Uptime</span>
              <span className="text-[11px] text-gray-300">{uptime}</span>
            </div>
          </div>
          <div className="flex items-center space-x-3">
            <a
