        ...
        headers: [
          {
            ...
            value: `
              default-src 'self';
              script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.googleapis.com https://*.gstatic.com https://*.tradingview.com https://static.cloudflareinsights.com https://*.cloudflareinsights.com;
              connect-src 'self' https://*.googleapis.com https://*.dexscreener.com https://*.geckoterminal.com https://base-mainnet.g.alchemy.com wss://base-mainnet.g.alchemy.com https://api.coingecko.com http://localhost:3000 http://192.168.86.250:3000 https://*.tradingview.com https://*.walletconnect.com https://explorer-api.walletconnect.com https://pulse.walletconnect.org https://api.web3modal.org wss://*.walletconnect.com wss://relay.walletconnect.com https://*.reown.com https://*.cloudflareinsights.com;
